...
import PageLayout from "./NavProps/PageLayouts";
    ...
    <nav className="mainmenu-nav">
      <ul className="mainmenu">
        ...
        <li className="has-dropdown has-menu-child-item">
          ...
          >
            {MenuData &&
              MenuData.menuData.map((data: any, index: number) => {
                if (data.menuType === "default-dropdown") {
                  const elements = data.menuItems?.map((value: { title: string,  submenuItems: any}, innerIndex: number) => (
                    <li className="has-dropdown" key={innerIndex}>
                      <Link href="#">{value.title}</Link>
                      <ul className="submenu">
                        {value.submenuItems?.map(
                          (submenuItem: { link: string, title: string}, submenuItemIndex: number) => (
