...
import CourseFilter from "./CourseFilter2";
...
const CategoryHead = ({
  ...
  const handleButtonClick = (courseType: any) => {
                          ...
                          >
                            ...
                            {courseType === "All Course" ? (
                              <span className="course-number">
                                {category.filter((course: any) => course).length}
                              </span>
                            ) : (
                              <span className="course-number">
                                0
                                {
                                  category.filter(
                                    (course: any) => course.courseType === courseType
                                  ).length
                                }
                              </span>
                            )}
