...
const BlogGridTop = ({ BlogData }: BlogDataType) => {
  return (
    <>
      <div className="row g-5">
        ...
        >
          {BlogData.slice(0, 1).map((data: {thumbnail: string, slug: string, title: string, desc: string}, index: number) => (
            <div
        ...
        <div
          ...
          data-sal-duration="800"
        >
          {BlogData.slice(1, 4).map((data: {thumbnail: string, slug: string, title: string, desc: string}, index: number) => (
            <div
