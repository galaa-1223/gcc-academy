...
const BlogList = ({ blogdata }: any | undefined) => {
          ...
          <div className="row row--30 gy-5">
            <div className="col-lg-8">
              <div className="row g-5">
                {blogdata &&
                  selectedBlogs.slice(1, 5).map((data: {slug: string, thumbnail: string, title: string, desc: string; authorImg?: any}, index: number) => (
